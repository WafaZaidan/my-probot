...
module.exports = function (app) {
    ...
    app.on("pull_request_review_comment.created", function (context) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("lala");
                    app.log("errrr");
                    return [4 /*yield*/, context.log.error("errrrrrrrr")];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
